                    ...
                    <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
                        <div>
                            ...
                            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
                                ...
                                overcome pain and movement limitations. My
                                approach combines evidence-based treatment
                                techniques with compassionate care to create
                                personalized recovery plans.
                            </p>
                            <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                                I specialize in orthopedic rehabilitation,
                                sports injuries, and chronic pain management. My
                                goal is to not just treat symptoms, but to
                                address the root cause of your condition and
                                empower you with the knowledge and tools for
                                long-term wellness.
                            </p>
                        </div>
